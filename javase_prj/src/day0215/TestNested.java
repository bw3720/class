...
public class TestNested {
	...
	static class Nested{
		...
		public static void inMethod() {
			...
			//안쪽클래스의 method에서는 바깥 클래스의 자원을 직접 사용할수 있다.
//			insI = 100; //인스턴스 영역의 변수는 사용할 수 없다.
			staI =100;
			System.out.println("바깥클래스의 변수 : "+staI);
//			outInsMethod(); //인스턴스 영역의 method는 사용불가.
			outStaMethod(); //스태틱 영역의 method는 사용가능.
			//영역이 다르면 못씀!
	...
	public static void main(String[] args) {
		//클래스 영역안에 static 클래스로 업무를 구분하여 만들어 사용하는 것이므로, 객체화 없이
