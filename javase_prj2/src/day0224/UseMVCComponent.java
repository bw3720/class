...
public class UseMVCComponent extends JFrame {
	...
	public UseMVCComponent() {
		super("MVC Patter이 도입된 컴포넌트의 사용");
		...
		//AWT에서는 디자인 객체에 값이 합쳐져서 제작된 컴포넌트 (Choice)였지만, 
		//Swing(JComboBox)에서는 업무별로 구분하여 컴포넌트를 제작하였다.
		...
		DefaultTableModel dtm = new DefaultTableModel(columnaNames,0); // --> 처음부터 붙어 나옴
