...
public class UseLambda {
	...
	/**
	 * interface를 매개변수로 정의한method가 존재.
	 * @param in1
	 */
	...
	public static void main(String[] args) {
		...
		//문법 : ( )->{ };
		Inter1 in1 = ()->{ System.out.println("반환형 없고, 매개변수 없는형의 method 구현"); };
		...
		//매개변수명은 달라도 된다. 데이터 형만 같으면 됨.
		Inter2 in2 = (String name)->{ System.out.println("반환형 없고, 매개변수 있는형의 method " + name); };
		//호출
		in2.test("한상민");
		...
		Runnable r =()->{for(int i =1;i<101;i++) {
