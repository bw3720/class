...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" info="request 내장객체의 사용." %>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
String ip=request.getRemoteAddr();//접속자의 IP조수를 얻는다.
...
%>
	<ul>
		...
		<li>parameter(이름 같은 경우): <%=request.getParameter("age") %></li>
		<!-- 이름이 같은 파라메터를 getPrameter method를 사용하여 값을 얻으면
			  가장 처음에 들어오는 값을 받는다. -->
		<li>parameter(이름 같은 경우): 
		<%
		...
		<li>접속자 ip port: <%=request.getRemotePort() %></li>
	</ul>
