...
<div>
<%//POST방식의 한글처리: (GET방식에서는 동작하지 않는다.)
	//request객체가 사용되기 전 encoding하여 변환한 문자열을 받는다.
	request.setCharacterEncoding("UTF-8");
%>
	<strong><%=request.getMethod() %></strong>방식의 요청
	<div>
	<%
		//name속성의 "값"이 유일한 HTML Form Control의 값 받기
		...
		//value속성이 없고 체크된 상태면 "on"이 입력되고, 체크된 상태가 아니면 null이 입력된다.
