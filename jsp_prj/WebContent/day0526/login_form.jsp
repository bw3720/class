<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%
    //Cookie 사용.
    //읽기: 접속자가 들어오면 접속자에 생성되어있는 모든 쿠키를 읽는다.( 다른 서버에서 심은 쿠키는 읽어들일 수 없다. )
...
<tr>
	<td>
		<input type="text" name="id" id="id" tabindex="1" value="<%=cookieId%>"/><br/>
		<input type="checkbox" name="idFlag" <%="".equals(cookieId)?"":" checked='checked' " %>/>아이디저장
	</td>
