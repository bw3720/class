...
<div>
<%-- enctype="multipart/form-data"인 경우에는 request객체 사용하여 parameter를 받을 수 없다. <%
...
//parameter 값받기 : MultipartRequest사용.
...
<li><label>파일명</label>: 변경파일명<strong><%=reName %></strong>(원본: <%=originName %>)</li>
</ul>
