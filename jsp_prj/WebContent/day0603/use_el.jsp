...
<body>
	...
	<ul>
		...
		<li>6*3=${6*3}</li>
		<li>6/3=${6/3}</li>
		<li>6/4=${6/4}</li> <!-- EL에서 나눈 결과가 실수로 나온다. -->
		<li>6%2=${6%2} (${6 mod 2})</li>
		
		<li><strong>관계연산자</strong></li>
		<li>6>3=${6>5} (${6 gt 3})</li>
		<li>6<3=${6<3} (${6 lt 3})</li>
		<li>6>=3=${6>=3} (${6 ge 3})</li>
		<li>6<=3=${6<=3} (${6 le 3})</li>
		<li>6==3=${6==3} (${6 eq 3})</li>
		<%-- <li>6!=3=${6!=3} (${6 ne 3})</li> --%>

		<li><strong>논리연산자</strong></li>
		<li>ture && true =${true && true} (${true and true})</li>
		<li>false||false =${false || false} (${false or false})</li>

		<li><strong>삼항연산자</strong></li>
		<li>2는 ${2%2==0 ? "짝수" : '홀수' }</li><!-- EL에서 문자열은 " 와 ' 룰 모두 사용할 수 있다. -->
		<li><strong>파라메터 받기</strong></li>
		<li>이름 : ${param.name}</li>
		<li><a href="use_el.jsp?name=test">요청</a> </li>
		<li>
